...
[cite_start]While HarmBench provides the _standardized evaluation framework_ (behaviors, generation length, and static classifiers), RIOT is the _attack algorithm_ that can be used within such a framework to find vulnerabilities dynamically through iterative feedback[cite: 1, 3].
